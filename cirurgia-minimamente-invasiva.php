...
<head>
	...
	<!-- Page Title -->
	<title>Cirurgia Minimamente Invasiva</title>
...
<body>
	<div id="wrapper">
		...
		<main id="main">
			...
			<section class="bg-img-full main-banner bg-img-parallax" style="background-image: url(assets/images/bg/cirurgia.jpg);">
